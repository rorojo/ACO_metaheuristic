...
#define MAX_CITIES 48  //Numero maximo de ciudades o nodos definidos con anterioridad
...
#define MAX_ANTS 96   //Numero maximo de hormigas. Se define igual a la cantidad de nodos (cada nodo se inicializa con una hormiga)
...
#define RANK_W MAX_ANTS/2.0 //define un ranking para la mitad de poblacion de hormigas
...
void init() //inicializacion de las hormigas y caminos 
{
    ...
    f1.open("city_data.txt"); //leo las coordenadas de las ciudades para visitar
     	...
     	if(ants[ant].tabu[to] == 0)
     	{
     		p = antProduct(from,to)/denom;
            	...
            	if(x < p)
            	{
                	...
                	break; //sale del bucle cuando (x < p)
               }
        }
    }while(1);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 //esta funcion organiza las hormigas por rango
 ...
 void sortAnts()
{
    ...
    //se organizan las hormigas por longitud de recorrido
    for(i=0;i<MAX_CITIES;i++)
    {
    ...
    for(ant=0;ant<RANK_W-1;ant++)
    {
        for(i=0;i<MAX_CITIES;i++)
        {
            ...
            else
            {
             ...
             //suma nueva feromona al camino deacuerdo al rango de la hormiga
...
void emitDataFile(int bestIndex)
{
    ...
    f1.open("tiempo.csv", std::ios_base::app); //registro todos los tiempos para varias ejecuciones del script
    f1<<best<<",";
    f1.close();
