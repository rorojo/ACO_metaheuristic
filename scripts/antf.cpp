...
#define MAX_ANTS 12   //Numero maximo de hormigas. Se define igual a la cantidad de nodos (cada nodo se inicializa con una hormiga)
...
#define MAX_TOURS 100 //numero maximo de viajes que puede realizar una hormiga
...
{         
    ...
    ifstream inFile;//leo el archivo de datos
...
{
    ofstream f1;
    f1.open("Data.txt" , std::ios_base::app);
    //f1.open("Data.txt");
    antType antBest;
...
int main()
{
    ...
    srand(time(NULL)); //seed para la funcion random depende del tiempo
